        ...
        <div className="grid gap-12">
          {components.map((c) => (
            <Link
              key={c.href}
              href={c.href}
              className="block rounded-lg border border-stone-300 px-16 py-12 text-14 font-semibold hover:border-primary-brand-400 hover:bg-primary-brand-25 transition-colors"
            >
              {c.name}
            </Link>
          ))}
