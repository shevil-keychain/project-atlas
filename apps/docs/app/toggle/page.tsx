        ...
        >
          ...
          <Row label="Interactive">
            <div className="grid gap-12 sm:grid-cols-2">
              <div className="flex items-center justify-between rounded-lg border border-stone-200 bg-white px-16 py-12">
                <span className="text-14 font-semibold text-foreground">Auto-save drafts</span>
                <ToggleSwitch checked={baseUnchecked} onCheckedChange={setBaseUnchecked} />
              </div>
              <div className="flex items-center justify-between rounded-lg border border-stone-200 bg-white px-16 py-12">
                <span className="text-14 font-semibold text-foreground">Email alerts</span>
                <ToggleSwitch checked={baseChecked} onCheckedChange={setBaseChecked} />
              </div>
            </div>
          </Row>
