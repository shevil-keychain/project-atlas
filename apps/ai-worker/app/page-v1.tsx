...
const createSeedThread = (
  { title, daysAgo, minutesAgo = 0 }: SeedThreadConfig,
  index: number
): ChatThread => {
              ...
              {isChatView && selectedThread ? (
                <div className="relative z-10 flex min-h-0 flex-1 flex-col">
                  <div className="bg-surface-card px-24 py-16">
                    <div className="mx-auto flex w-full max-w-720 items-center gap-12">
                      {(() => {
                        const cw = customWorkers.find((c) => c.label === selectedThread.worker)
                        return cw ? (
                          <span
                            className={cn(
                ...
                <>
                  ...
                  >
                    <div className="flex flex-1 flex-col items-center justify-center px-24 py-32">
                      <div className="flex w-full max-w-720 flex-col items-center gap-12 text-center">
                        ...
                        <Button
                          ...
                          variant="secondary"
                          size="sm"
                          className={cn("mt-4", getWorkerRevealClass("delay-200"))}
                        ...
                        <div className={cn("mt-32 flex w-full flex-col items-center gap-y-8 text-left", getWorkerRevealClass("delay-300"))}>
                          {orderedWorkerRows.map((row, rowIndex) => (
                                  ...
                                  >
                                    <span className="flex items-center gap-8">
                                      {cw ? (
                                        ...
                                        >
                                          {getCustomWorkerIcon(cw.iconName, cw.iconColor, 10)}
                                        </span>
                                      ) : (
                                        <img
                                          src={workerIconByLabel[worker] ?? "/ai-worker-avatar.svg"}
                        ...
                        <Button
                          variant="ghost"
                          size="sm"
                          className={cn("mt-12", getWorkerRevealClass("delay-500"))}
                          onClick={() => setIsBrowseWorkersOpen(true)}
                        >
                          Browse all workers
                        </Button>
                      </div>
                    ...
                    <div className="relative z-10 shrink-0 px-24 pb-40">
