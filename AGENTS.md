...
6. Install dependencies from the root: `pnpm install`
...
5. **Build incrementally** — layout shell first, then page header, then individual sections.
6. **Check demo pages** — each component has a demo at `apps/docs/app/[component-name]/page.tsx`.
...
- Tiptap, Lucide React, 974 custom icons, Manrope typeface
