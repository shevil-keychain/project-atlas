    ...
    <div className="flex h-screen flex-col">
      ...
      <div className="flex flex-1 items-center justify-center bg-stone-50">
        <div className="max-w-md text-center font-medium">
          <BackButton />
          <h1 className="mb-2 text-xxl font-bold tracking-tight text-stone-900">
            Top Bar Component
          </h1>
          <p className="text-stone-500 font-medium">
            The top navigation bar with help, notifications, and user avatar.
          </p>
          <div className="mt-6 rounded-lg border border-stone-200 bg-white p-4 text-left text-default text-stone-600 font-medium">
